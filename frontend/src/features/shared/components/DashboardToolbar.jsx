...
function DashboardToolbar({
  ...
  return (
    <div className={`dashboard-toolbar-container ${isGraphMode ? 'dashboard-toolbar-container--graph-mode' : ''}`}>
      {!isGraphMode && (
      ...
      <div className={`dashboard-toolbar ${isGraphMode ? 'dashboard-toolbar--graph-mode' : ''}`} role="region" aria-label="Dashboard toolbar">
        <SearchInput
          id="step-search"
          label="Search"
          value={search}
        ...
        {/* Neural Graph Mode Toggle */}
        <div className="dashboard-toolbar__graph-toggle">
          <button
            className={`dashboard-toolbar__graph-btn ${isGraphMode ? 'is-active' : ''}`}
            type="button"
            onClick={onGraphModeToggle}
            title="Toggle Neural File Galaxy Graph"
          >
